...
export default function Person1Detail() {
  const [, setLocation] = useLocation();
  const analysisData = getStoredAnalysis();
  const partner = analysisData?.partner_1 || {};
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 py-12 px-4">
      <div className="container max-w-6xl mx-auto">
        ...
        <Button
          ...
          className="mb-8 bg-purple-500/20 hover:bg-purple-500/30 border border-purple-400/50 text-purple-300"
        >
        ...
        >
          ...
          >
            <img 
              src="/images/archetypes/ChatGPTImage18жовт.2025р.,15_00_47.png" 
              alt="Person A"
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent" />
            <div className="absolute bottom-0 left-0 right-0 p-8">
              <span className="text-purple-400 text-sm font-semibold tracking-wider mb-2 block">PERSON A</span>
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-4">
                {partner.name || "The Dreamer"}
              </h1>
              <p className="text-2xl text-purple-300 mb-2">
                {partner.personality?.jungian_archetype || "The Visionary Explorer"}
              </p>
              <p className="text-lg text-gray-300">
                {partner.emoji} {partner.personality?.enneagram_type || "Type 4 - The Individualist"}
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <motion.div
            ...
            className="p-8 rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-400/30"
          >
            ...
            <p className="text-2xl text-pink-300 font-semibold">
              {partner.love_language || "Quality Time"}
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="p-8 rounded-2xl bg-gradient-to-br from-purple-500/10 to-blue-500/10 border border-purple-400/30"
          >
            <div className="flex items-center gap-3 mb-4">
            ...
            <p className="text-2xl text-blue-300 font-semibold">
              {partner.attachment_style || "Secure"}
            </p>
          </motion.div>
        </div>
        ...
        {partner.emotions && (
          ...
          >
            ...
            <div className="p-8 rounded-2xl bg-purple-500/10 border border-purple-400/30">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="text-lg font-semibold text-purple-300 mb-3">Primary Emotions</h4>
                    ...
                    {(partner.emotions.primary_emotions || []).map((emotion, index) => {
                      ...
                      return (
                        <div key={index} className="flex items-center gap-3">
                          ...
                          <span className="text-purple-300 text-sm w-8">{intensity}/10</span>
                        </div>
                      );
                    })}
                  </div>
                ...
                <div>
                  <h4 className="text-lg font-semibold text-purple-300 mb-3">Hidden Emotions</h4>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {(partner.strengths || ['Empathetic', 'Creative', 'Loyal']).map((strength, index) => (
              <motion.div
                key={index}
        ...
        >
          ...
          <div className="space-y-4">
            {(partner.growth_areas || ['Setting boundaries', 'Self-care']).map((area, index) => (
              <motion.div
                key={index}
