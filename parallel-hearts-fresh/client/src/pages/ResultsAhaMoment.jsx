...
import { Sparkles, Users, User, TrendingUp, TrendingDown, Minus, BookOpen, Film, FileText, X, Heart, Brain, Target, Lightbulb , Home } from 'lucide-react'
import { generateScenarioVideo, pollVideoStatus, getScenarioIdFromTitle, getStoredAnalysis } from '../services/api'
import ModernArchetypeCards from '../components/ModernArchetypeCards'
...
export default function ResultsAhaMoment() {
  ...
  const [showArchetypeCards, setShowArchetypeCards] = useState(true)
  ...
  // Show archetype cards view first
  if (showArchetypeCards) {
    return (
...
<div className="fixed inset-0 pointer-events-none">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {analysisData && <EnhancedAnalysisView analysisData={analysisData} />}
